class PeopleCounterDashboard {
    constructor() {
        ...
        this.filteredData = [];
        this.charts = {};
        // Obfuscated endpoint (XOR encrypted)
        const encrypted = [7, 21, 21, 28, 18, 58, 57, 57, 26, 29, 29, 63, 17, 30, 21, 30, 24, 7, 63, 27, 30, 57, 28, 17, 22, 28, 30, 25];
        const key = 42;
        this.apiUrl = encrypted.map(c => String.fromCharCode(c ^ key)).join('');
